#!/usr/bin/env sh
# -----------------------------------------------------------------------------
#  Get Terraform Modules (Inside CodeBuild)
# -----------------------------------------------------------------------------
...
module_cleanup() {
  print_line2
  get_time
  echo "$COL_BLUE[ $DATE ] ##### Rebuild Module(s): $COL_END"
...
module_terrafom_community() {
  print_line2
  get_time
  echo "$COL_BLUE[ $DATE ] ##### Download Community Module(s): $COL_END"
  module_download $PATH_MODULES_COMMUNITY $SUBMODULE_TERRAFORM_COMMUNITY
}

module_terrafom_officials() {
  print_line2
  get_time
  echo "$COL_BLUE[ $DATE ] ##### Download Officials Module(s): $COL_END"
  module_download $PATH_MODULES_OFFICIALS $SUBMODULE_TERRAFORM_OFFICIALS
}
