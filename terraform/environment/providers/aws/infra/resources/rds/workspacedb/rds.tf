# ==========================================================================
#  Resources: RDS workspacedb / rds.tf (RDS Terraform)
# --------------------------------------------------------------------------
#  Description
# --------------------------------------------------------------------------
#    - VPC References
...
resource "aws_security_group" "rds_default" {
  name        = "devopscorner-sg-rds-workspacedb-${var.env[local.env]}"
...
module "db" {
  ...
  identifier        = "workspacedb-${var.env[local.env]}"
  ...
  # final_snapshot_identifier = "workspacedb-${var.env[local.env]}"
